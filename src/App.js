...
import {Typography, Paper, Grid, createMuiTheme} from '@material-ui/core';
...
import {BretGrid, BretGridItem, GridContainer, GridItem, GridItemCanvas} from "./layout/Grid"
...
//    const [json, setJson] = useState(null)
    ...
    if (localStorage.getItem("appState")) {
        //setJson(localStorage.getItem("appState"))
        json = localStorage.getItem("appState")
    }

    console.log(`the app state: ${json}`)

    return (
        <ThemeProvider theme={theme}>
         <div className="h-full h-screen">
         <Editor
              resolver={{BretGrid, BretGridItem, Card, Button, Text, CardTop, CardBottom, Container, GridContainer, GridItem, ImageContainer, Textbox, SimpleLink, SimpleLinkNav, GridItemCanvas}}
              enabled={enabled}
              onRender={RenderNode}
          >
              <Viewport>
...
//   return (
//     <div className="App">
//       <Grid container key="root-container">
